...
export default function Navbar() {
    ...
    return (
        <nav
            className={`flex flex-wrap items-center justify-between fixed top-0 w-full min-h-[70px] bg-[var(--color-bg)] shadow-[0_10px_30px_-10px_#0f182a] px-[50px] z-20 ${showLinks ? "show-nav" : ""
                }`}
        >
            {/* Logo */}
            ...
            {/* Nav Links */}
            <ul
                className={`flex max-[976px]:flex-col max-[976px]:justify-center max-[976px]:items-center max-[976px]:fixed max-[976px]:bottom-0 max-[976px]:h-screen max-[976px]:p-8 max-[976px]:bg-[var(--color-bg)] max-[976px]:transition-all max-[976px]:duration-[400ms] max-[976px]:ease-in-out ${showLinks
                ...
                {navItems.map((item) => (
                    ...
                    >
                        <a
                            ...
                            className={`hover:text-[var(--color-tertiary)] transition-all duration-[400ms] ${activeNav === item.href ? "text-[var(--color-tertiary)]" : ""
                                }`}
                        >
                            {item.label}
                        </a>
