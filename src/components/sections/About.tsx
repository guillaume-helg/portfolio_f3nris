    ...
    return (
        <section id="about" className="mt-12 py-8">
            ...
            <div className="w-3/4 mx-auto grid grid-cols-[35%_50%] gap-[15%] max-lg:grid-cols-1 max-lg:gap-0 max-sm:grid-cols-1">
                {/* Image */}
                <div className="w-full rounded-2xl bg-gradient-to-br from-transparent via-[var(--color-bg-variant)] to-transparent grid place-items-center max-lg:w-1/2 max-lg:mx-auto max-lg:mb-16 max-sm:w-[65%] max-sm:mb-12">
                    <div className="w-full aspect-square rounded-2xl overflow-hidden rotate-[10deg] hover:rotate-0 transition-all duration-[400ms]">
                        <Image
                ...
                <div className="max-sm:text-center">
                    <div className="grid grid-cols-3 gap-4 max-sm:grid-cols-2">
                        <article className="bg-[var(--color-bg-variant)] border border-transparent rounded-2xl p-8 text-center hover:bg-transparent hover:border-[var(--color-primary-variant)] transition-all duration-[400ms] cursor-default">
                            <FaAward className="text-xl mb-4 mx-auto" />
                        ...
                        <article className="bg-[var(--color-bg-variant)] border border-transparent rounded-2xl p-8 text-center hover:bg-transparent hover:border-[var(--color-primary-variant)] transition-all duration-[400ms] cursor-default">
                            <FiUsers className="text-xl mb-4 mx-auto" />
                    ...
                    <p className="text-[var(--color-fontnew)] my-12 max-lg:my-4 max-sm:my-6 max-sm:text-left">
